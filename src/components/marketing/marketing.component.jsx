...
const Marketing = () => {
  const marketingData = [
    {
      title: "Marketing",
      quote: `“Take your web3 marketing strategy to the next level”`,
      text: "Let wanmina help you unlock your brand’s full potential through our high-level product promotion strategies aimed at your target audience",
      marketingImage:
        "https://github.com/ojieprincewill/Wanmina-Illustrations/blob/master/%231/image14.jpg?raw=true",
    },
    {
      ...
      {marketingData.map((data, index) => (
        ...
        >
          <div className="marketing-text-cont">
            <p className="marketing-title">{data.title}</p>
            <p className="marketing-text">{data.text}</p>
          </div>
