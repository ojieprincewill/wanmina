...
const Design = () => {
  const designData = [
    {
      title: "Design",
      quote: `“We Empower Your Brand with Exceptional Design”`,
      text: "In today's competitive sphere, design is very important in order to stand out from the crowd and connect with their target audience. Let's help you build a well-designed brand identity. Let’s help you look good.",
      designImage:
      ...
      {designData.map((data, index) => (
        ...
        >
          <div className="design-text-cont">
            ...
            <p className="design-text">{data.text}</p>
          </div>
